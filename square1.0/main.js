...
window.addEventListener("keydown", function(e){
	var key = e.keyCode;
	//alert(key);
	if(key==37) {p1.dir="left";}
		else if(key==38) {p1.dir="up";e.preventDefault();}
			else if(key==39) {p1.dir="right";}
				else if(key==40) {p1.dir="down";e.preventDefault();}
...
window.addEventListener("keyup", function(e){
	var key = e.keyCode;
	//alert(key);
	if(key==37 && p1.dir=="left") {p1.dir="null";}
		else if(key==38 && p1.dir=="up") {p1.dir="null";}
			else if(key==39 && p1.dir=="right") {p1.dir="null";}
				else if(key==40 && p1.dir=="down") {p1.dir="null";}
